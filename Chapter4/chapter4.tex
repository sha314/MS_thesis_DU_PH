...
\section{Algorithm} \label{sect:algorithm}
	...
	\subsection{Bond Percolation}
		...
		Using this process in mind we measure various quantity, for example Entropy, Spanning probability, Order Parameter etc., and the we use the scaling relation to obtain the exponents which is done in chapter (\ref{chapter.redefinition-ballistic-deposition}) for site percolation.

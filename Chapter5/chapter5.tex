...
\section{Random Sequential Ballistic Deposition}
	...
	\begin{figure}[h]
		...
		\begin{subfigure}{0.4\textwidth}
			...
			\caption{}
		\end{subfigure}
		\caption{(a) A spherical object is dropped and the place it was dropped to was empty. (b) Empty place is occupied by the spherical object.}
		\label{fig:rsbd-1}
	\end{figure}
	...
	\begin{figure}[h]
		...
		\begin{subfigure}{0.4\textwidth}
			...
			\caption{}
		\end{subfigure}
		\caption{(a) A spherical object is dropped but the location it was dropped to is not empty. (b) Since the location is not empty the object simply falls down to one of the four sides.}
		\label{fig:rsbd-2}
	\end{figure}

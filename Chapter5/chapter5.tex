...
\section{Redefinition of Site Percolation}
	...
	\log(S) = d_f \log(L)
	\end{equation}
	Here $S$ is the average size of the spanning cluster at critical point. Using this we get the figure (\ref{fig:fractal-dimension-L0}). And we obtain fractal dimension $d_f$ for $L_0$ which is listed in (\ref{tab:cluster-info}). 

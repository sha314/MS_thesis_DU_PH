...
\section{Redefinition of Site Percolation}
	...
	\begin{figure}
		...
		\label{fig:fractal-dimension-L0}
	\end{figure}
...
\section{Random Sequential Ballistic Deposition}
	...
	\log(S) = d_f \log(L)
	\end{equation}
	Here $S$ is the average size of the spanning cluster at critical point. Using this we get the figure (\ref{fig:fractal-dimension}). And we obtain fractal dimension $d_f$ for $L_0,L_1,L_2$ which is listed in (\ref{tab:cluster-info}). 
	\begin{figure}[h]
		\centering
		\captionsetup[subfigure]{width=0.9\textwidth}
		\begin{subfigure}{0.4\textwidth}
